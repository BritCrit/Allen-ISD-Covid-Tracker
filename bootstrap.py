...
# Store known static numbers from offical dashboard
...
students_current = students_current[['school','school_type','active_cases']].sort_values('active_cases', ascending=False)
        ...
        dbc.Card(
            dbc.CardBody(
                [
                    ...
                    # html.P(
                    #     "Click to view specific school trend",
                    #     className="card-text",
                    # ),
                    # dbc.Button(
                    #     "Click here",id='school_chart_button', color="primary", className="btn btn-primary disabled", n_clicks=0
                    # ),
                ]
            )
        ),
...
alert = html.Div(
    [
        ...
        html.Hr(),
        dbc.Alert(
            "This dashboard uses data from the Allen ISD daily covid case reporting to map and show trends within our local schools. Developed by a concerned parent and for concerned parents. If you have concerns about the information presented I recommend contacting your schools administrative staff. Stay safe.",
            id="alert-auto",
            is_open=True,
            duration=4000,
        ),
    ...
    [
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink("Official Dashboard", href="https://docs.google.com/spreadsheets/d/e/2PACX-1vS7pP0EYu0ZhN-VJLX6b_OqFqXwFv_3ndAtb41T12APwCnNqcOJ3mEPs_wFcA36jeXABZ0xi2yofmJ6/pubhtml?gid=0&single=true", active="exact"),
                html.Hr(),
            ],
            vertical=True,
            pills=True,
